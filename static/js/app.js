require(["comp/menubar",
    ...
    "comp/otherview",
    "comp/logout",
    "comp/ml/associationanalysisationview",
    "comp/datapre"
], function(Menu, Main, About, Data, Viz, CLS, Regression, Cluster, EventBus ,Other , LogOut , AA , DataPre) {
    ...
    //
    var handleDataPremenu = function() {
        ReactDOM.render(
            React.createElement(DataPre, null),
            document.getElementById('container')
        );
    };
    ...
    var handleAAmenu = function() {
    ReactDOM.render(
        React.createElement(AA, null),
        document.getElementById('container')
        );
    };
	...
	var handleOther = function() {
        ReactDOM.render(
            React.createElement(Other, null),
            document.getElementById('container')
        );
    };
