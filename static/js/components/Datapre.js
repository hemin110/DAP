define(["comp/common/collapse",
                ...
                <div>
                    <form role="form" method="post" encType="multipart/form-data"
                        ...
                        <div className="form-group">
                            <input id="input-id" type="file" multiple  name="file2" ></input>
                        </div>
                    </form>
                </div>
            );
    ...
    var DataTablePanel = React.createClass({
        render: function(){
            return (
                <Panel id="dataTablePanel" title="数据展示">
                </Panel>
            );
        },
        componentDidMount: function() {
                ...
                <div className="row">
                    <div className="col-md-4">
                        <div className="panel-group" role="tablist" aria-multiselectable="true">
                        	...
                        	<Collapse title="添加数据组" id="DataUploadCollapse">
                                <DataUploadPanel></DataUploadPanel>
                            </Collapse>
                        
                            <Collapse title="数据预处理" id="DataPreCollapse">
                            	<DataPrePro></DataPrePro>
