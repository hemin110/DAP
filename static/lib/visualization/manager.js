...
define(["viz/line", "viz/bar", "viz/area", "viz/pie", "viz/scatter", "viz/treemap"], function (Line, Bar, Area, Pie, Scatter, TreeMap) {
    var vizMetaData = [Line.meta, Bar.meta, Area.meta, Pie.meta, Scatter.meta, TreeMap.meta];
    ...
    var _getViz = function _getViz(type) {
        if (type === "line") {
            return Line;
        } else if (type === "bar") {
            return Bar;
