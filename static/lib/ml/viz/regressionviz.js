...
define([], function () {
    ...
    var RegressionViz = function RegressionViz(option) {
    ...
    RegressionViz.prototype.render = function () {
        ...
        //Draw the X,Y axises
        this._svg.append("g").attr("class", "x axis").attr("transform", "translate(0," + (this._height + 10) + ")").call(this._xAxis).append("text").attr("class", "label").attr("x", this._width).attr("y", -6).style("text-anchor", "end").text("samples");
        ...
        this._svg.append("text").attr("class", "title").attr("dy", ".71em").text("_____*****" + "RMSE = " + this._title + "*****_____");
        this._svg.append("path").attr("d", line(this._predictData)).style("stroke", color("regression")).style("stroke-width", 3).style("fill", "None");
    };
